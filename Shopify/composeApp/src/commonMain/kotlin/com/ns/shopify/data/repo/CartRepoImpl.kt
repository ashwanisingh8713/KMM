...
class CartRepoImpl(private val apolloClient: ApolloClient) : ICartRepo {
    ...
    override suspend fun CartBuyerIdentity(
        buyerIdentity: CartBuyerIdentityInput,
        cartId: String
    ): ApolloResponse<CartBuyerIdentityUpdateMutation.Data> {
        return apolloClient.mutation(CartBuyerIdentityUpdateMutation(buyerIdentity = buyerIdentity, cartId = cartId))
            .execute()
    }
